...
// draw a particular frame at a particular location (if specified). That frame and its contents are not managed by the sprite
...
// make this iteration of the sequence its final iteration, adding a new callback if desired
...
var spriteSet = function() {
	...
	if (arguments.length == 1) {
		...
		throw "Invalid parameters to spriteSet construct";
	}
};
