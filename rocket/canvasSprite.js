...
cSprite.setDefaults = function(newDefaults){
	var n;
	for(n in this.defaults){
		if(newDefaults[n] != undefined){
			this.defaults[n] = newDefaults[n];
		}
	}
}
...
cSprite.prototype.rotateTo = function(angle){
	this.rotation = angle;
	return this;
};
